...
@section('dashboard-title', 'Acht | '.'Willkommen '.Auth()->user()->forname)
@section('styles')
...
<script>
    ...
    function fetchProduct() {
        ...
        $.ajax({
            type: 'GET',
            url: '{{ route("category.ajax", ":categoryId") }}'.replace(':categoryId', categoryId),
            dataType: 'json',
            success: function (response){
